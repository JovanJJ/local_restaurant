...
export default function CTASection({ lang }: { lang: string }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(176,122,79,0.22),transparent_42%),linear-gradient(180deg,rgba(31,23,19,0.96)_0%,rgba(24,17,14,0.98)_100%)] pointer-events-none" />
      ...
      >
        ...
        <p className="mt-6 max-w-5xl font-serif text-3xl font-light leading-tight tracking-wide text-[#E8DCCF] sm:text-5xl lg:text-6xl">
          {isEn
